...
<%
	...
	{%>
		<div style="width:100%;height:600px;background-color:blue;color:#00ffff;border-radius:32px;font-family: sans-serif;font-size: 20px;">
	<br>
	...
	<br>
	<p style="width: 20%;height: 40px;background-color:#00aa00;color: #ff0000;margin-left:40%;border-radius:32px;font-family: cursive;
	font-size: 26px;font-variant: capatelise;text-align: center;">
		Welcome User
	</p>
	
	<div style="width: 90%;height: 260px;background-color:#00aa00;color: #ffff00;padding-left:30px;padding-right:30px;margin-right:2.5%;
