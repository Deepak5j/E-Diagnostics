...
%>
	...
	<span style="padding-left: 22px;"></span>Hello!<span style="padding-right: 22px;"></span><%=uid%>
		<span style="padding-top:0px;float:right;margin-right: 30px;">
			...
			<form style="display:inline" method="get" action="/esportsclub/Logout">								
	...
	<div style="width:100%;height:100%;background-color:#0000aa;color:#00ffff;
		...
		<div>
			<table  align="center" style="font-size: 20px;font-family: serif;border-collapse:collapse;
				...
				<tr>
  				...
  				<%
  					String strsql="select * from logininfo where type!=?";
  					ResultSet rs=CrudOperation.getData(strsql, "admin");
  					int i=0;
  					while(rs.next())
  					{i++;
  				%>
  				<tr>
  					...
  					<td><%=rs.getString("pass")%></td><!-- from table column -->
  					<td><%=rs.getString("type")%></td>
  				</tr>
  				<%}%>
  					<!--  sapn>Total accounts: <%=i %></sapn-->
				</table>
		</div>
	</div><%}%>
</body>
